...
const App = () => {
  ...
  const { people, chicken, setPeople } = useFibonaChicken()
  ...
  return (
    <>
      ...
      <>
        Links
        <ul>
          <li>기여: <a href="https://github.com/kanziw/fibonachicken" target="_blank" rel="noreferrer">https://github.com/kanziw/fibonachicken</a></li>
          <li>출처: <a href="https://fibonachicken.herokuapp.com/" target="_blank" rel="noreferrer">https://fibonachicken.herokuapp.com/</a></li>
        </ul>
      </>
    </>
  )
